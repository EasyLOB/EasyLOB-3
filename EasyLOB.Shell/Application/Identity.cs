    ...
    partial class Program
    {
            ...
            where TEntity : ZDataBase
        {
            IIdentityGenericApplication<TEntity> application =
                ManagerHelper.DIManager.GetService<IIdentityGenericApplication<TEntity>>();
            ...
            where TEntity : ZDataBase
        {
            IIdentityGenericApplicationDTO<TEntityDTO, TEntity> application =
                ManagerHelper.DIManager.GetService<IIdentityGenericApplicationDTO<TEntityDTO, TEntity>>();
            ZOperationResult operationResult = new ZOperationResult();
